...
/// and navigate to the "Live Trainings".. you'll find an object pooling video their.
/// </summary>
public class ObjectPoolScript : MonoBehaviour

{
    public static ObjectPoolScript Instance;     //reference to this pool script(used when getting an object from this pool)
